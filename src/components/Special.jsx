...
import Wood3D, {Wood3DSpecial} from "./Wood3D";
...
const SpecialPage = () => {
  ...
  return (
    ...
    <div style={HomeStyle.container}>
      ...
      <div style={{position:'absolute', top:'50%', left:'50%', width:'100vw', height:'100vh', zIndex:'0', transform: 'translate(-50%, -50%)', opacity:'0.7'}}>
            <NetworkGraphSpecial />
      </div>
    </div>
  )
